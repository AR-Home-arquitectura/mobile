...
class _ItemsUploadScreenState extends State<ItemsUploadScreen>
{
          ...
          ListTile(
            ...
            title: SizedBox(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  hintText: "Teléfono del Vendedor",
                  hintStyle: TextStyle(color: Colors.grey),
                  border: InputBorder.none,
                ),
              ),
  ...
  validateUploadFormAndUploadItemInfo() async
  {
    if(imageFileUint8List != null)
    {
      ...
      {
        Fluttertoast.showToast(msg: "Por favor rellena todos los campos");
      }
    }
    else
    {
      Fluttertoast.showToast(msg: "Seleccione un archivo de imagen");
    }
  }
  ...
  saveItemInfoToFirestore()
  {
    ...
    Fluttertoast.showToast(msg: "Tu item se ha cargado satisfactoriamente.");
